    ...
    <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8 mt-20 w-full border-t border-gray-400 ">
      ...
      <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
        {footerNavs.map((item, idx) => (
          <li className=" hover:text-primaryH" key={idx}>
            <NavLink to={item.to} className="font-extrabold">
              {item.name}
            </NavLink>
          </li>
        ))}
        ...
        <div className="mt-6 sm:mt-0">
          <ul className="flex items-center space-x-4">
            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
              <Link to="/notFound">
                <svg
                  className="svg-icon w-6 h-6 text-blue-500 hover:text-blue-400"
                  viewBox="0 0 20 20"
                >
                  <path
                    fill="none"
            ...
            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
              <Link to="/notFound">
                <svg
                  className="svg-icon w-6 h-6 text-blue-700 hover:text-blue-500"
                  viewBox="0 0 20 20"
                >
                  <path
                    fill="none"
            ...
            <li className="w-10 h-10 border rounded-full flex items-center justify-center">
              <Link to="/notFound">
                <svg
                  className="svg-icon w-6 h-6 hover:text-red-400 duration-150 text-red-600"
                  viewBox="0 0 48 48"
                >
